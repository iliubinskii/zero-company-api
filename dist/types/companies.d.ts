...
export interface CompaniesService {
     ...
     */
    readonly addCompany: (company: Company) => Promise<ExistingCompany | undefined>;
    /**
     ...
     */
    readonly updateCompany: (id: string, company: Company) => Promise<ExistingCompany | undefined>;
}
export interface CompanyControllers {
     ...
     */
    addCompany: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    /**
     * Deletes a company from the database.
     * @param req - The request object.
     * @param res - The response object.
