...
const header = zod_1.default.string().min(1, (0, i18next_1.t)("NameIsRequired"));
const images = zod_1.default.array(zod_1.default.string().min(1, (0, i18next_1.t)("NameIsRequired")));
const logo = zod_1.default.string().min(1, (0, i18next_1.t)("NameIsRequired"));
